export default {
  ...
  name: "Card",
  description: `
A Card element is used to group similar elements together and highlight the grouping with a visible border. 
The card can have child elements. The card has an list of 'children' elements.
...
A Card element is used to group similar elements together and highlight the grouping with a visible border. 
The card can have child elements. The card has an list of 'children' elements.
A card has an property 'flex-direction'. It can have the values 'row' and 'column'. 
row means that the elements are aligned horizontal from left to right, column means the elements are aligned vertical from top to down.
`,
  container: true,
  x: 0,
