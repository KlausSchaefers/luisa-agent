...
A button has a label value in the 'props' object. A button can have a 'variant' 
property, which can have the following values: 'Primary', 'Secondary', 'FullWidth', 'Disabled' and 'Danger'. 
